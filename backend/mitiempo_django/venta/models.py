...
class Ventas(models.Model):
    ...
    id_caja = models.ForeignKey('caja.Caja', models.DO_NOTHING, db_column='id_caja')
...
class DetVentas(models.Model):
    ...
    # En venta/models.py, dentro de la clase DetVentas
    id_venta = models.ForeignKey('venta.Ventas', on_delete=models.CASCADE, related_name='detalles')
