...
=======
        import compra.signals  # Nueva línea: Conecta signals
>>>>>>> def20f14 (creacion de caja, movimiento_caja, mod venta mod compra):backend/mitiempo_django/compra/apps.py
